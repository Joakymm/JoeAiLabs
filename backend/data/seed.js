...
async function seed() {
  try {
    ...
    const toolMap = {
      ...
      'HR & Recruitment':             { toolType: 'automation',       toolName: 'ChatGPT' },
      ...
      'eCommerce & Customer Support': { toolType: 'automation',       toolName: 'ChatGPT' },
      ...
      'Copywriting':                  { toolType: 'writing-copy',     toolName: 'ChatGPT' },
      'Analytics':                    { toolType: 'research-analysis', toolName: 'ChatGPT' },
      'Blog Writing':                 { toolType: 'writing-copy',     toolName: 'ChatGPT' },
      'Video':                        { toolType: 'video-generation', toolName: 'Runway' },
      'LinkedIn':                     { toolType: 'writing-copy',     toolName: 'ChatGPT' },
      'Code Generation':              { toolType: 'code-generation',  toolName: 'GitHub Copilot' },
      'Meta-Prompting':               { toolType: 'writing-copy',     toolName: 'ChatGPT' },
      'System Prompts':               { toolType: 'writing-copy',     toolName: 'ChatGPT' },
      'Optimization':                 { toolType: 'writing-copy',     toolName: 'ChatGPT' },
      'YouTube':                      { toolType: 'video-generation', toolName: 'Runway' },
      'Marketing':                    { toolType: 'writing-copy',     toolName: 'ChatGPT' },
      'Engagement':                   { toolType: 'writing-copy',     toolName: 'ChatGPT' },
      'Community':                    { toolType: 'automation',       toolName: 'ChatGPT' },
      'Pricing':                      { toolType: 'writing-copy',     toolName: 'ChatGPT' },
      'Culture':                      { toolType: 'writing-copy',     toolName: 'ChatGPT' },
      'Documentation':                { toolType: 'writing-copy',     toolName: 'ChatGPT' },
      'Nutrition':                    { toolType: 'writing-copy',     toolName: 'ChatGPT' },
      'Recovery':                     { toolType: 'writing-copy',     toolName: 'ChatGPT' },
      'Customer Service':             { toolType: 'automation',       toolName: 'ChatGPT' },
      'Content':                      { toolType: 'writing-copy',     toolName: 'ChatGPT' },
      'Reporting':                    { toolType: 'research-analysis', toolName: 'ChatGPT' },
      'Writing':                      { toolType: 'writing-copy',     toolName: 'ChatGPT' },
      'Python':                       { toolType: 'code-generation',  toolName: 'GitHub Copilot' },
      'Production':                   { toolType: 'video-generation', toolName: 'Runway' },
      'Remote':                       { toolType: 'automation',       toolName: 'ChatGPT' },
      'Marketplace':                  { toolType: 'automation',       toolName: 'ChatGPT' },
      'SEO':                          { toolType: 'writing-copy',     toolName: 'ChatGPT' },
      'CRM':                          { toolType: 'automation',       toolName: 'ChatGPT' },
      'Instagram Reel':               { toolType: 'video-generation', toolName: 'Runway' },
      'TikTok':                       { toolType: 'video-generation', toolName: 'CapCut' },
      'Facebook Ads':                 { toolType: 'writing-copy',     toolName: 'ChatGPT' },
      'Email Marketing':              { toolType: 'writing-copy',     toolName: 'ChatGPT' },
      'Keyword Research':             { toolType: 'research-analysis', toolName: 'ChatGPT' },
      'On-Page SEO':                  { toolType: 'writing-copy',     toolName: 'ChatGPT' },
      'Backlink Outreach':            { toolType: 'writing-copy',     toolName: 'ChatGPT' },
      'Social Media':                 { toolType: 'writing-copy',     toolName: 'ChatGPT' },
      'Code Review':                  { toolType: 'code-generation',  toolName: 'GitHub Copilot' },
      'Business Intelligence':        { toolType: 'research-analysis', toolName: 'ChatGPT' },
      'Course Design':                { toolType: 'writing-copy',     toolName: 'ChatGPT' },
      'Cold Outreach':                { toolType: 'writing-copy',     toolName: 'ChatGPT' },
      'Job Descriptions':             { toolType: 'writing-copy',     toolName: 'ChatGPT' },
      'Planning':                     { toolType: 'automation',       toolName: 'ChatGPT' },
      'Training Plans':               { toolType: 'writing-copy',     toolName: 'ChatGPT' },
      'Product Listings':             { toolType: 'writing-copy',     toolName: 'ChatGPT' },
      'Trip Planning':                { toolType: 'writing-copy',     toolName: 'ChatGPT' },
      'Landing Pages':                { toolType: 'writing-copy',     toolName: 'ChatGPT' },
      'Practice':                     { toolType: 'writing-copy',     toolName: 'ChatGPT' },
      'Instagram':                    { toolType: 'writing-copy',     toolName: 'ChatGPT' },
      'Pinterest':                    { toolType: 'writing-copy',     toolName: 'ChatGPT' },
      'Twitter/X':                    { toolType: 'writing-copy',     toolName: 'ChatGPT' },
      'Google Ads':                   { toolType: 'writing-copy',     toolName: 'ChatGPT' },
      'Influencer Marketing':         { toolType: 'writing-copy',     toolName: 'ChatGPT' },
      'Content Repurposing':          { toolType: 'writing-copy',     toolName: 'ChatGPT' },
      'Hashtag Strategy':             { toolType: 'writing-copy',     toolName: 'ChatGPT' },
      'Technical SEO':                { toolType: 'writing-copy',     toolName: 'ChatGPT' },
      'Local SEO':                    { toolType: 'writing-copy',     toolName: 'ChatGPT' },
      'Content Strategy':             { toolType: 'writing-copy',     toolName: 'ChatGPT' },
      'Link Building':                { toolType: 'writing-copy',     toolName: 'ChatGPT' },
      'SERP Analysis':                { toolType: 'research-analysis', toolName: 'ChatGPT' },
      'Newsletter':                   { toolType: 'writing-copy',     toolName: 'ChatGPT' },
      'Press Release':                { toolType: 'writing-copy',     toolName: 'ChatGPT' },
      'Debugging':                    { toolType: 'code-generation',  toolName: 'ChatGPT' },
      'Architecture':                 { toolType: 'code-generation',  toolName: 'ChatGPT' },
      'Database':                     { toolType: 'code-generation',  toolName: 'ChatGPT' },
      'API Development':              { toolType: 'code-generation',  toolName: 'ChatGPT' },
      'DevOps':                       { toolType: 'automation',       toolName: 'ChatGPT' },
      'Testing':                      { toolType: 'code-generation',  toolName: 'ChatGPT' },
      'Security':                     { toolType: 'code-generation',  toolName: 'ChatGPT' },
      'Data Cleaning':                { toolType: 'research-analysis', toolName: 'ChatGPT' },
      'Visualization':                { toolType: 'research-analysis', toolName: 'ChatGPT' },
      'Forecasting':                  { toolType: 'research-analysis', toolName: 'ChatGPT' },
      'A/B Testing':                  { toolType: 'research-analysis', toolName: 'ChatGPT' },
      'Dashboard':                    { toolType: 'research-analysis', toolName: 'ChatGPT' },
      'Video Script':                 { toolType: 'video-generation', toolName: 'Runway' },
      'Cold Calling':                 { toolType: 'writing-copy',     toolName: 'ChatGPT' },
      'Proposal':                     { toolType: 'writing-copy',     toolName: 'ChatGPT' },
      'Follow-Up':                    { toolType: 'writing-copy',     toolName: 'ChatGPT' },
      'Consultative':                 { toolType: 'writing-copy',     toolName: 'ChatGPT' },
      'ROI':                          { toolType: 'writing-copy',     toolName: 'ChatGPT' },
      'Interview Questions':          { toolType: 'writing-copy',     toolName: 'ChatGPT' },
      'Onboarding':                   { toolType: 'automation',       toolName: 'ChatGPT' },
      'Performance Review':           { toolType: 'writing-copy',     toolName: 'ChatGPT' },
      'Offer Letters':                { toolType: 'writing-copy',     toolName: 'ChatGPT' },
      'Sprint Planning':              { toolType: 'automation',       toolName: 'ChatGPT' },
      'Risk Management':              { toolType: 'automation',       toolName: 'ChatGPT' },
      'Meeting Facilitation':         { toolType: 'automation',       toolName: 'ChatGPT' },
      'Stakeholder':                  { toolType: 'writing-copy',     toolName: 'ChatGPT' },
      'Mental Health':                { toolType: 'writing-copy',     toolName: 'ChatGPT' },
      'Sleep':                        { toolType: 'writing-copy',     toolName: 'ChatGPT' },
      'Habit Building':               { toolType: 'writing-copy',     toolName: 'ChatGPT' },
      'Chain-of-Thought':             { toolType: 'writing-copy',     toolName: 'ChatGPT' },
      'Templates':                    { toolType: 'writing-copy',     toolName: 'ChatGPT' },
      'Evaluation':                   { toolType: 'research-analysis', toolName: 'ChatGPT' },
      'Workflow':                     { toolType: 'automation',       toolName: 'ChatGPT' },
      'Product Launch':               { toolType: 'writing-copy',     toolName: 'ChatGPT' },
      'Reviews':                      { toolType: 'writing-copy',     toolName: 'ChatGPT' },
      'Abandoned Cart':               { toolType: 'automation',       toolName: 'ChatGPT' },
      'Upsell':                       { toolType: 'writing-copy',     toolName: 'ChatGPT' },
      'Packing':                      { toolType: 'automation',       toolName: 'ChatGPT' },
      'Budget':                       { toolType: 'writing-copy',     toolName: 'ChatGPT' },
      'Language':                     { toolType: 'research-analysis', toolName: 'ChatGPT' },
      'Photo':                        { toolType: 'image-generation', toolName: 'Midjourney' },
      'Digital Nomad':                { toolType: 'writing-copy',     toolName: 'ChatGPT' },
      'UX Research':                  { toolType: 'research-analysis', toolName: 'ChatGPT' },
      'Information Architecture':     { toolType: 'presentation',     toolName: 'ChatGPT' },
      'Accessibility':                { toolType: 'presentation',     toolName: 'ChatGPT' },
      'Wireframing':                  { toolType: 'presentation',     toolName: 'ChatGPT' },
      'Vocabulary':                   { toolType: 'research-analysis', toolName: 'ChatGPT' },
      'Grammar':                      { toolType: 'research-analysis', toolName: 'ChatGPT' },
      'Pronunciation':                { toolType: 'research-analysis', toolName: 'ChatGPT' },
      'Reading':                      { toolType: 'research-analysis', toolName: 'ChatGPT' },
      'Inventory':                    { toolType: 'automation',       toolName: 'ChatGPT' },
      'Shipping':                     { toolType: 'automation',       toolName: 'ChatGPT' },
      'Supplier':                     { toolType: 'automation',       toolName: 'ChatGPT' },
      'Demand Planning':              { toolType: 'automation',       toolName: 'ChatGPT' },
      'Sustainability':               { toolType: 'research-analysis', toolName: 'ChatGPT' },
      'Affiliate':                    { toolType: 'writing-copy',     toolName: 'ChatGPT' },
      'Personal Brand':               { toolType: 'writing-copy',     toolName: 'ChatGPT' },
      'Competitive':                  { toolType: 'research-analysis', toolName: 'ChatGPT' },
      'SaaS':                         { toolType: 'writing-copy',     toolName: 'ChatGPT' },
      'Growth':                       { toolType: 'writing-copy',     toolName: 'ChatGPT' },
      'International':                { toolType: 'writing-copy',     toolName: 'ChatGPT' },
      'Core Web Vitals':              { toolType: 'research-analysis', toolName: 'ChatGPT' },
      'E-commerce':                   { toolType: 'automation',       toolName: 'ChatGPT' },
      'Blog':                         { toolType: 'writing-copy',     toolName: 'ChatGPT' },
      'Case Study':                   { toolType: 'writing-copy',     toolName: 'ChatGPT' },
      'eBook':                        { toolType: 'writing-copy',     toolName: 'ChatGPT' },
      'Social':                       { toolType: 'writing-copy',     toolName: 'ChatGPT' },
      'PR':                           { toolType: 'writing-copy',     toolName: 'ChatGPT' },
      'Git':                          { toolType: 'code-generation',  toolName: 'GitHub Copilot' },
      'Docker':                       { toolType: 'automation',       toolName: 'ChatGPT' },
      'GraphQL':                      { toolType: 'code-generation',  toolName: 'ChatGPT' },
      'Performance':                  { toolType: 'research-analysis', toolName: 'ChatGPT' },
      'Migration':                    { toolType: 'code-generation',  toolName: 'ChatGPT' },
      'AI Integration':               { toolType: 'code-generation',  toolName: 'ChatGPT' },
      'SQL':                          { toolType: 'code-generation',  toolName: 'ChatGPT' },
      'Statistics':                   { toolType: 'research-analysis', toolName: 'ChatGPT' },
      'Pitch Deck':                   { toolType: 'presentation',     toolName: 'Beautiful.ai' },
      'Closing':                      { toolType: 'writing-copy',     toolName: 'ChatGPT' },
      'Discovery':                    { toolType: 'writing-copy',     toolName: 'ChatGPT' },
      'Objections':                   { toolType: 'writing-copy',     toolName: 'ChatGPT' },
      'Referral':                     { toolType: 'writing-copy',     toolName: 'ChatGPT' },
      'Learning':                     { toolType: 'research-analysis', toolName: 'ChatGPT' },
      'DEI':                          { toolType: 'writing-copy',     toolName: 'ChatGPT' },
      'Succession':                   { toolType: 'writing-copy',     toolName: 'ChatGPT' },
      'Estimation':                   { toolType: 'automation',       toolName: 'ChatGPT' },
      'Retro':                        { toolType: 'automation',       toolName: 'ChatGPT' },
      'Tooling':                      { toolType: 'automation',       toolName: 'ChatGPT' },
      'HIIT':                         { toolType: 'writing-copy',     toolName: 'ChatGPT' },
      'Yoga':                         { toolType: 'writing-copy',     toolName: 'ChatGPT' },
      'Wellness':                     { toolType: 'writing-copy',     toolName: 'ChatGPT' },
      'Supplements':                  { toolType: 'writing-copy',     toolName: 'ChatGPT' },
      'Frameworks':                   { toolType: 'writing-copy',     toolName: 'ChatGPT' },
      'Techniques':                   { toolType: 'writing-copy',     toolName: 'ChatGPT' },
      'Guardrails':                   { toolType: 'writing-copy',     toolName: 'ChatGPT' },
      'Conversion':                   { toolType: 'writing-copy',     toolName: 'ChatGPT' },
      'Klaviyo':                      { toolType: 'automation',       toolName: 'ChatGPT' },
      'Road Trip':                    { toolType: 'writing-copy',     toolName: 'ChatGPT' },
      'Solo':                         { toolType: 'writing-copy',     toolName: 'ChatGPT' },
      'Photography':                  { toolType: 'image-generation', toolName: 'Midjourney' },
      'Workcation':                   { toolType: 'writing-copy',     toolName: 'ChatGPT' },
      'Design Systems':               { toolType: 'presentation',     toolName: 'Figma' },
      'Mobile':                       { toolType: 'presentation',     toolName: 'Figma' },
      'E-commerce UX':                { toolType: 'presentation',     toolName: 'Figma' },
      'Listening':                    { toolType: 'research-analysis', toolName: 'ChatGPT' },
      'Speaking':                     { toolType: 'research-analysis', toolName: 'ChatGPT' },
      'Exam Prep':                    { toolType: 'research-analysis', toolName: 'ChatGPT' },
      'Warehouse':                    { toolType: 'automation',       toolName: 'ChatGPT' },
      'Last Mile':                    { toolType: 'automation',       toolName: 'ChatGPT' },
      'Compliance':                   { toolType: 'automation',       toolName: 'ChatGPT' },
      'Risk':                         { toolType: 'automation',       toolName: 'ChatGPT' },
      'Prospecting':                  { toolType: 'writing-copy',     toolName: 'ChatGPT' },
      'Clean Code':                   { toolType: 'code-generation',  toolName: 'ChatGPT' },
      'Presentation':                 { toolType: 'presentation',     toolName: 'ChatGPT' },
      'Productivity':                 { toolType: 'automation',       toolName: 'ChatGPT' },
      'Posture':                      { toolType: 'writing-copy',     toolName: 'ChatGPT' },
      'Creative':                     { toolType: 'writing-copy',     toolName: 'ChatGPT' },
      'Retention':                    { toolType: 'writing-copy',     toolName: 'ChatGPT' },
      'Volunteer':                    { toolType: 'writing-copy',     toolName: 'ChatGPT' },
      'Portfolio':                    { toolType: 'presentation',     toolName: 'ChatGPT' },
      'Immersion':                    { toolType: 'research-analysis', toolName: 'ChatGPT' },
      'Technology':                   { toolType: 'research-analysis', toolName: 'ChatGPT' },
      'TypeScript':                   { toolType: 'code-generation',  toolName: 'GitHub Copilot' },
      'Running':                      { toolType: 'health-fitness',   toolName: 'ChatGPT' },
      'Landing Page':                 { toolType: 'presentation',     toolName: 'ChatGPT' },
      'Motivation':                   { toolType: 'writing-copy',     toolName: 'ChatGPT' },
      'Freight':                      { toolType: 'automation',       toolName: 'ChatGPT' },
      'Direct Mail':                  { toolType: 'writing-copy',     toolName: 'ChatGPT' },
    };
